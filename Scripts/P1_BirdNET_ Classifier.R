################################################################################
# Title: BirdNET Classification
# BirdNet R workflow, Script 1 of 3
# Author: Will Harrod
...
# Install packages 
# install.packages("tidyverse", "birdnetR")
...
# Directory to save the .csv classification output
csv_dir <- "Data"
...
# Heading for BirdNet output .csv
