################################################################################
# Title: Preparing a subset of BirdNET classifications to be validated
# BirdNet R workflow, Script 2 of 3
# Author: Will Harrod
...
# Install packages 
# install.packages("tidyverse", "seewave", "tuneR", "warbleR", "birdnetR")
...
birdnet_file <- "uf_birdnet_classif.csv"
...
# Downsample back to 100 and save as a .csv
class_to_valid %>%
  group_by(Species) %>%
